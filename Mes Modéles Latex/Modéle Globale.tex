...
%\date{\today} %pour afficher la date du jour
...
%\tableofcontents  %affiche la table des matières concu automatiquement
  ...
  %texte
   ...
   % \href{https://tiaportal_formation_automatisme.solutions-industrielles.com/}{lien vers le site de formation} %pour faire un lien vers un site internet
